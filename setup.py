...
setup(
    name="redis-simpler-cache",
    version="0.0.7",
    author="Jan Berktold",
    author_email="jan+rediscache@berktold.co",
    description="redis-simple-cache is a pythonic interface for creating a cache over redis. "
                ...
                "This package is a fork of redis-simple-cache aiming to provide support for all python versions & simplify the API",
    license="3-clause BSD",
    keywords="decorator decorators redis cache",
    url="https://github.com/janberktold/redis-simpler-cache",
